...
MODEL_PATH = os.path.join(BASE_DIR, 'models', 'mobilenetv2_improved.keras') # Keras
...
if __name__ == "__main__":
  image_path = os.path.join(BASE_DIR, 'data', 'test', 'sexy', 'sexy_130.jpeg') # Ganti dengan path gambar yang ingin diprediksi
